...
int main(int argc, char *argv[]) {
	...
	long long A = S(32) - 1, B = T(2), C = T(3), D[33], d[33], E[8], F = C * 1032 + 1, G[33], g[33], H = F;
	...
	int I = ~f(D, 2 * A + 1) & A;
	long long J = write("PK\3\4"W"\1%c%c%c0\xed\xc0\x81\x08%c%c%c\xc0\xb0\xfbS_d\x0b", Z, Z, V, Z, 0, 0);
